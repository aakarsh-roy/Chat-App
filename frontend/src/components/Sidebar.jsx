...
export default function Sidebar({ onProfileClick, onSearchClick }) {
  ...
  return (
    <div className="w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      {/* Header */}
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-primary-600 text-white">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-300 dark:focus:ring-primary-500"
            value={searchQuery}
          ...
          filteredConversations.map((conversation) => (
            <div
              ...
              className={`p-4 border-b border-gray-100 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition ${
                currentConversation?._id === conversation._id ? 'bg-primary-50 dark:bg-primary-900/30' : ''
              }`}
            >
